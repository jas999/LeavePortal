		...
		<div class="col-sm-6">
			<div class="form-group">
				<label for="project">Project</label> <input class="form-control"
					id="project" value="${project}" readonly required type="text"
		...
		<div class="col-sm-6">
			<div class="form-group">
				<label for="tLead">Team Lead</label> <input class="form-control"
					id="tLead" required value="${lead}" readonly type="text"
					name="tLead" placeholder="Team Lead" />
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group">
				<label for="manager">Project Manager</label> <input
					class="form-control" id="manager" required value="${manager}"
					readonly type="text" name="manager" placeholder="Team Lead" />
			</div>
		</div>
	</div>
	<div class="form-row">
		<div class="col-sm-6">
			<div class="form-group">
				<label for="ticket">Ticket/SCR</label> <input class="form-control"
					id="ticket" required type="text" name="ticket" autocomplete="off" />
			</div>
		</div>
		<div class="col-sm-6">
			<div class="form-group">
				<label for="comp-date">Date</label> <input
					...
					type="text" name="comp-date" value="yy-mm-dd" autocomplete="off" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<textarea class="form-control" required name="comp-desc"
			placeholder="Brief Description" rows="3" autocomplete="off"></textarea>
	</div>
	<div class="from-check" style="display: inherit; margin: 20px;">
		<input type="checkbox" class="form-check-input" id="avail"
			name="avail" value="avail" /> <label class="form-check-label"
			for="avail">Availing against Extra Nights</label>
	</div>
