...
<table class="table hover nowrap  mt-5" id="data-table">
	<thead>
		<tr>
			...
			<th scope="col">Start Date <i class="fas fa-sort ml-1"
				onclick="sort()"></i></th>
			<th scope="col">End Date <i class="fas fa-sort ml-1"
				onclick="sort()"></i></th>
			<th scope="col">Total Days <i class="fas fa-sort ml-1"
				onclick="sort()"></i></th>
			<th scope="col">Type <i class="fas fa-sort ml-5"
				onclick="sort()"></i></th>
	...
	<tbody>
		...
		<tr id=" <%=resultSet.get(i).getId()%>" class="targetRow">
			...
			<% } else if ((resultSet.get(i).getStatus()).equals("Rejected")) { %>
			<!-- status == rejected -->
